...
module ApplicationHelper
  ...
  def link_to_issue(issue, options={})
    ...
    s << "<span class='arrow green_info'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span> <br/><div class='desc'>#{ best_in_place issue, :description, :as => :textarea, :ok_button => 'Save', :cancel_button => 'Cancel'  }</div>".html_safe if options[:display_desc_in_tree]
    s
  end
